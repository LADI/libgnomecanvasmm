...
: Gtk::VBox (false, 4)
{
    ...
    m_parent1 = manage (new Gnome::Canvas::Group (*canvas->root ()));
    Gnome::Canvas::Rect* rect1 = manage (new Gnome::Canvas::Rect (*m_parent1));
    ...
    m_parent2 = manage (new Gnome::Canvas::Group (*canvas->root (),
                                                  200.0, 0.0));
    Gnome::Canvas::Rect* rect2 = manage (new Gnome::Canvas::Rect (*m_parent2));
    ...
    Gnome::Canvas::Ellipse* ellipse1
        = manage (new Gnome::Canvas::Ellipse (*m_parent1));
    ...
    ellipse1->signal_event ()
        .connect (bind (slot (*this, &Features::itemEvent), ellipse1));
    
  
    Gnome::Canvas::Group* group 
        = manage (new Gnome::Canvas::Group (*m_parent2, 100.0, 100.0));
    group->signal_event ()
        .connect (bind (slot (*this, &Features::itemEvent), group));
    Gnome::Canvas::Ellipse* ellipse2
        = manage (new Gnome::Canvas::Ellipse (*group));
...
bool
Features::itemEvent (GdkEvent* event,
