...
: Gtk::VBox (false, 4)
{
    ...
    for (int i = 0; i < 15; ++i) {
        ...
        Gnome::Canvas::Rect* rect 
            = manage (new Gnome::Canvas::Rect (*m_board.back (),
                                               ...
                                               PIECE_SIZE, 
                                               PIECE_SIZE));
        rect->property_fill_color () = getPieceColor (i);
	...
	char buf[20];
        ...
        m_board.back ()->signal_event ()
            .connect (bind (slot (*this, &Fifteen::pieceEvent),
                            m_board.back (),
                            text));
    }
    ...
    button->signal_clicked ().connect (slot (*this, &Fifteen::scramble));
...
bool
Fifteen::pieceEvent (GdkEvent *event,
